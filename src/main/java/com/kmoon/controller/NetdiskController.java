package com.kmoon.controller;


import com.kmoon.config.FileUploadProperteis;
import com.kmoon.config.NetdiskConfig;
import com.kmoon.model.File;
import com.kmoon.model.User;
import com.kmoon.service.FileService;
import com.kmoon.utils.UUIDUtils;
...
public class NetdiskController {
    ...
    public String deleteFile(@PathVariable Integer fileId, HttpSession session) {
        User user = (User)session.getAttribute("user");
        com.kmoon.model.File file = fileService.findFileById(fileId);
    ...
    public String upload(MultipartFile file, HttpSession session, Model model) {
        ...
        try {
            ...
            File fileInfo = new com.kmoon.model.File();
